#!/usr/bin/env python3
"""Fold-shirt MULTI-ENV — UMI finray soft-gripper replay (shirt cloth, N envs).
...
Usage:
    ...
    PYTHONPATH=. CASE39ME_NUM_ENVS=4 CASE39ME_HEADLESS=1 GRIP_MODE=stitch python examples/replay_foldshirt_finray_multienv.py
"""
import umi_finray_lib as L
if __name__ == "__main__":
    L.run_replay("foldshirt", default_envs=4)

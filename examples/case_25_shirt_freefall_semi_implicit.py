#!/usr/bin/env python3
"""Shirt free-fall (semi-implicit) demo — replicates ./gipc 25.

Same scene as case 24 but enables semi-implicit beta-decay early exit
for faster convergence at the cost of slight accuracy loss.

Usage:
    python examples/case_25_shirt_freefall_semi_implicit.py
"""
...
def main():
    ...
    def callback():
        ...
        expanded, _ = psim.Begin("Shirt Free-Fall / Semi-Implicit (Case 25)", True)
        if expanded:
            if running[0]:

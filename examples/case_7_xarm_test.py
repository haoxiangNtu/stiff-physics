#!/usr/bin/env python3
"""XArm7 with gripper test demo — replicates ./gipc 7.

Loads xarm7_with_gripper.urdf at scale 0.3, Y=1.5, with joint_strength_ratio=1000.
No motors — the arm hangs under gravity with joint constraints.

Usage:
    python examples/case_7_xarm_test.py
"""
...
def main():
    ...
    def callback():
        ...
        expanded, _ = psim.Begin("XArm7 Test (Case 7)", True)
        if expanded:
            if running[0]:

#!/usr/bin/env python3
"""Arm + Shirt free-fall interaction (semi-implicit) — Case 26.

XArm7+Gripper URDF + shirt_6436v.obj free-falling.
Use the joint sliders to move the arm and interact with the fallen shirt.
...
def main():
    ...
    def callback():
        ...
        if _begin_window("Arm + Shirt Free-Fall (Case 26)"):
            if running[0]:

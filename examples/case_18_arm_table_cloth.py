#!/usr/bin/env python3
"""Arm + Table + Cloth demo — replicates ./gipc 18.

XArm7+Gripper URDF + fixed ABD table + ABD cube on table + FEM cloth above.
Same structure as case 15 with arm+table setup. Interactive joint control.

Usage:
    python examples/case_18_arm_table_cloth.py
"""
...
def main():
    ...
    def callback():
        ...
        expanded, _ = psim.Begin("Arm + Table + Cloth (Case 18)", True)
        if expanded:
            if running[0]:

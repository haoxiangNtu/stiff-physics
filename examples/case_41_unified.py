...
RIGID_MSH    = _ASSETS_DIR + "sim_data/hybrid_d/CASE41_UNIFIED_rigid.msh"
RIGID_REMAP  = _ASSETS_DIR + "sim_data/hybrid_d/CASE41_UNIFIED_rigid_remap.npz"
UNIFIED_NPZ  = _ASSETS_DIR + "sim_data/hybrid_d/CASE41_UNIFIED_unified.npz"
...
def main():
    ...
    def callback():
        ...
        psim.Begin("case_41_unified — fine softpad (ARM=1.0) A variant", True)

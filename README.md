...
cd stiff-physics
pip install https://github.com/haoxiangNtu/stiff-physics/releases/download/v0.8.0/stiff_physics-0.8.0-cp311-cp311-linux_x86_64.whl polyscope scipy h5py
...
```bash
pip install https://github.com/haoxiangNtu/stiff-physics/releases/download/v0.8.0/stiff_physics-0.8.0-cp311-cp311-linux_x86_64.whl
```

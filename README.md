...
cd stiff-physics
pip install https://github.com/haoxiangNtu/stiff-physics/releases/download/v0.8.5.4/stiff_physics-0.8.5.4-cp311-cp311-linux_x86_64.whl polyscope scipy h5py

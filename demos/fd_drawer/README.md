...
| `docs/` | 三份技术文档(v1 原版 → v2 对称柜 → **v3 用户网格定稿**,含完整运行史与失败分析) |
...
pip install numpy scipy trimesh polyscope fast_simplification usd-core pillow
...
| 版本 | 柜子 | 交付 | 文档 |
|---|---|---|---|
| v1 | 程序化单抽屉柜 | `output/`(留在原工作区) | `docs/技术文档-v1-原版四段式.md` |
| v2 | 网格优化对称柜(双抽屉,上层物理) | `output_v2/` | `docs/技术文档-对称柜v2.md` |
| **v3(本发布)** | **用户自制双抽屉柜网格** | `outputs/` | `docs/技术文档-用户双抽屉柜v3.md` |
